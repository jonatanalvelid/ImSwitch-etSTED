...
def a_mock_bapta_calcium_spikes_cpu(img, bkg=None, binary_mask=None, testmode=False, min_dist=30, thresh_abs=0.08, num_peaks=5, noise_level=12, smoothing_radius=2, ensure_spacing=0, border_limit=10):
    f_multiply = 100
