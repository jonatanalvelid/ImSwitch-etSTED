...
def cd_vesicle_prox(img, bkg=None, binary_mask=None, testmode=False, exinfo=None, min_dist=4, 
    ...
    testmode - if to return extra images for testing the pipeline
    exinfo_prev_tracks - pandas dataframe of the detected vesicles and their track id from the previous frames
    ...
    track_len - number of last frames to keep in the tracking (more frames = slower track linking), has to be large enough to take an informed decision on event
