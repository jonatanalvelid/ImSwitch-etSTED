...
class EtSTEDWidget(Widget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.analysisDir = os.path.join(constants.rootFolderPath, 'etsted', 'analysis_pipelines')
        self.transformDir = os.path.join(constants.rootFolderPath, 'etsted', 'transform_pipelines')
    ...
    def initControls(self, *args):
        """ Initialize etSTED widget controls. """
        currentRow = 0
